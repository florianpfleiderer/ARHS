...
class Color(Enum):
    ...
    REAL_RED = ((0, 0, 255), (171, 46, 33), (10, 255, 255))
    REAL_GREEN = ((0, 255, 0), (63, 60, 60), (82, 255, 255))
    REAL_BLUE = ((255, 0, 0), (94, 55, 101), (103, 255, 255))
    REAL_YELLOW = ((0, 255, 255), (23, 70, 60), (34, 255, 220))
