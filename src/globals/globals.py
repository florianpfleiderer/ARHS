...
KINECT_OFFSET = (0.13, 0, 0.45) if SIMULATION_MODE else (0.10, 0, 0.54)
KINECT_DIMENSIONS = (480, 640)
...
LASER_OFFSET = (0.1, 0, 0.28) if SIMULATION_MODE else (0.09, 0, 0.3)
LASER_EDGE_THRESHOLD = 0.1
SCAN_MIN_ANGLE = -135
SCAN_MAX_ANGLE = 135
LASER_RANGE = (0, 6.0)
LASER_FOV = (360, 180)
LASER_DIMENSIONS = (200, 720)
